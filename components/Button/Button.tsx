...
export default function Button({ label, styles, path, wFull, loading, loadingLabel, onClick }: IButton) {
	...
	return (
		<button className={`${buttonStyles} ${loading && "opacity-50"}`} onClick={onClick}>
			{loading && (
				<svg
					aria-hidden="true"
					role="status"
